...
public enum ErrorCode {
    ...
    INVALID_KEY(1001,"Invalid meesage key", HttpStatus.BAD_REQUEST),
    ...
    PASSWORD_INVALID(1004,"Passwork lớn hơn 8 kí tự", HttpStatus.BAD_REQUEST),
    ...
    NOT_USERID_TESTID(1005, "test uest not existed", HttpStatus.BAD_REQUEST),
